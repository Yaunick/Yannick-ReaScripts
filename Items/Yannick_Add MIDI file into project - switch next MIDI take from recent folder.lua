-- @description Yannick_Add MIDI file into project - switch next MIDI take from recent folder
-- @author Yannick
-- @version 1.1
-- @about
...
-- @donation https://telegra.ph/How-to-send-me-a-donation-04-14
  ...
  reaper.Undo_EndBlock('Add MIDI file into project - switch next MIDI take from recent folder',-1)
  reaper.PreventUIRefresh(-1)
