-- @description Yannick_Propagate first selected MIDI item to all selected MIDI items (with pool them)
-- @author Yannick
-- @version 1.1
-- @about
...
-- @donation https://telegra.ph/How-to-send-me-a-donation-04-14
  ...
  reaper.Undo_EndBlock("Propagate first selected MIDI item to all selected MIDI items (with pool them)",-1)
  reaper.PreventUIRefresh(-1)
