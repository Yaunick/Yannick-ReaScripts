...
-- @donation https://www.paypal.com/paypalme/yaunick?locale.x=ru_RU
  ...
  then
    reaper.MB
    (
    'Incorrect value for "name" or "defaults_for_new_track" ' ..
    'or "monitor_rec_for_new_track" or "RGB" parameters. Look at the beginning of the script',
    'Error',
    0
    )
    nothing() return
  ...
  function Main()
    local space = string.rep(" ", number_of_spaces)
    local string_fx = ""
    local count_table = {}
    local find_start = 0
    local find_end = 0
